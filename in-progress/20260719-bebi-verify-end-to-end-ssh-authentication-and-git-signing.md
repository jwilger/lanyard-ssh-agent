...
- [x] Black-box tests cover SSH authentication through Lanyard
- [x] Black-box tests create and verify an SSH-signed Git commit
- [x] OpenSSH query and session-bind extensions are handled safely
