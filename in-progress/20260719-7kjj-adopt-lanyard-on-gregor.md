...
- 2026-07-20: Activated generation /nix/store/szm3fvmvykhcj73b73xzx12nv6riwimm. lanyard-ssh-agent.service is enabled/active with ready 1Password fallback; normal Zsh startup exports the stable socket. A disposable real ssh-agent presented as an SSH-forwarded login registered as ready, was selected ahead of fallback, and was removed on cleanup; fallback identities then returned. Existing attached Zellij client/server PIDs 6295/6298 both carry the stable socket. A disposable Git commit signed and verified via the stable socket with key SHA256:Fa/i+mjuGYJd8KbzsXhV2I87PNZ8q9S/k8BCW2ayIr0. Work was isolated in /home/jwilger/.build/nixos-lanyard-gregor; the pre-existing beads-sync worktree was untouched.
