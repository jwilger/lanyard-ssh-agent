...
- [x] A single main-branch workflow prepares signed release commits without a release PR, stages verified cargo-dist artifacts in a draft GitHub Release, publishes to crates.io, and only then makes the GitHub Release public
...
- 2026-07-20: CI recovery — Failure record: 0608f418799deec4a5e9b05ad15328a54aa1e018; run 29725921555; exact failed job check; failed step Check; strict Clippy reported four release-state harness lint violations. Diagnosis: test helper constructs violated repository restriction lints; classification=caused; the exact Clippy command and 11 focused tests passed after scoped edits. Next action: tested causal repair 323cd59. Release proof: replacement run 29726437076; terminal status=success; queued|pending|running=false.
- 2026-07-20: Integrated signed commit 8b5d9ac directly to main via merged PR #1. Formal final review completed with two clean iterations and no out-of-scope findings. Main CI 29736963892, Pages 29736963890, Release 29736963889, and Tiber trailer run 29736963900 all reached terminal success. Production Release correctly no-op'd because v0.1.0 was already complete. Verified crates.io v0.1.0, signed tag v0.1.0 at 0717dc4, public GitHub Release with x86_64/aarch64 artifacts, and all published checksum files. cargo package and the complete site check/build passed.
